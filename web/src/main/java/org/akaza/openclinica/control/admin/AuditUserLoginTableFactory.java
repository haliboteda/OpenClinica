        ...
        public Object getValue(Object item, String property, int rowcount) {
            ...
            if (userAccountId != null) {
               StringBuilder url = new StringBuilder();
                url.append("<a onmouseup=\"javascript:setImage('bt_View1','icon icon-search');\" onmousedown=\"javascript:setImage('bt_View1','icon icon-searchl');\" href=\"ViewUserAccount?userId="+userAccountId.toString());
                url.append("&amp;viewFull=yes\"><span hspace=\"6\" border=\"0\" align=\"left\" title=\"View\" alt=\"View\" class=\"icon icon-search\" name=\"bt_View1\"/></a>");
                value = url.toString();
            }
            return value;
        }
