...
<c:set var="firstPageQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1" />
<c:set var="prevPageQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=${table.currPageNumber - 1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1" />
<c:set var="nextPageQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=${table.currPageNumber + 1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1" />
<c:set var="lastPageQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=${table.totalPageNumbers}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1" />
<c:set var="viewAllQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=${1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=0&ebl_filterKeyword=&ebl_paginated=0" />
<c:set var="doNotPaginateQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=0" />
<c:set var="paginateQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1" />
<c:set var="removeFilterQuery" value="${table.baseGetQuery}&module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}&ebl_page=${table.currPageNumber}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=0&ebl_filterKeyword=&ebl_paginated=${paginated}" />
...
<table width="600" border="0" cellpadding="0" cellspacing="0" id="Table0">
    ...
    <td width="33%" valign="top" align="center" class="table_actions">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              style="margin-left:5px;float:right" width="24 " height="15" name="bt_View1" src="images/bt_Download.gif" border="0" alt="<fmt:message key="download_all_discrepancy_notes" bundle="${resword}"/>" title="<fmt:message key="download_all_discrepancy_notes" bundle="${resword}"/>"></a></c:if>
                </td>--%>
            </tr>
        </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="table_tools" nowrap>
                ...
                <!-- Add a new subject link -->
                <c:if test="${! (suppressAddSubject eq 'true')}">
                    <b> <a href="javascript:showSubjectRow('HideGroups', <c:out value="${groupCount+2}"/>, 'AddSubjectRow1','AddSubjectRow2');">
                        <fmt:message key="add_new_subject" bundle="${resworkflow}"/>
                    </a></b>
                </c:if></td>
        ...
        <td>
            <c:choose>
                <c:when test='${table.noColsMessage == ""}'>
                    <fmt:message key="there_are_no_columns_because_no_dnotes" bundle="${restext}"/>
                </c:when>
                <c:otherwise>
...
<tr valign="top">
    ...
    <c:forEach var="column" items="${table.columns}">
        ...
        <c:set var="orderByQuery" value="${table.baseGetQuery}&module=${module}&resolutionStatus=${param.resolutionStatus}&type=${param.type}&ebl_page=1&ebl_sortColumnInd=${i}&ebl_sortAscending=${showAscending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=${paginated}" />
        ...
        <div style="float:left"><c:if test="${column.showLink}"><a href="<c:out value="${orderByQuery}"/>"></c:if><c:out value="${column.name}" /><c:if test="${columnLen == (i + 1)}"><span style="visibility:hidden">invisible</span></c:if><c:if test="${column.showLink}"></a></c:if></div>
        <c:if test="${(table.sortingColumnInd == i) && column.showLink}"><div style="float:left;margin-left:5px">
            <c:choose>
